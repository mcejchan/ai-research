...
Plan file: /Users/michal/Projects/ai-research/plans/2026-05-18-2_quiz-dashboard-static-deploy-to-github-pages.md
Review feedback: The static conversion is simple, but the GitHub Pages step contradicts the deploy requirement because Pages cannot publish directly from arbitrary `/quiz` folder source on `main`; it needs root/docs or an Actions deploy path.
